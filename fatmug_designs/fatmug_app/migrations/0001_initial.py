    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor_code', models.CharField(help_text='A unique identifier for the vendor.', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acknowledgment_date', models.DateTimeField(help_text='Timestamp when the vendor acknowledged the PO.', null=True)),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fatmug_app.vender')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_response_time', models.FloatField(default=0, help_text='Historical record of the average response time.')),
                ('fulfillment_rate', models.FloatField(default=0, help_text='Historical record of the fulfilment rate.')),
                ('vender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fatmug_app.vender')),
            ],
        ),
    ]
